  ...
  return (
    <div className='w-full md:w-[1170px] mx-auto h-20 bg-black fixed top-0 left-1/2 -translate-x-1/2 z-[100] navbar-bg flex gap-6'>
        ...
        <div className='hidden md:flex gap-4 p-5 text-2xl font-bold ml-8 cursor-pointer'>
            <h3 className='hover:text-yellow-500'>Features</h3>
            <h3 className='hover:text-yellow-500'>Technology</h3>
            <h3 className='hover:text-yellow-500'>Agents</h3>
            <h3 className='hover:text-yellow-500'>Pricing</h3>
            <h3 className='hover:text-yellow-500'>Contact</h3>
        </div>
      ...
      {menuOpen && (
        <div className="absolute top-20 left-0 w-full bg-black text-yellow-400 flex flex-col items-center py-4 space-y-4 md:hidden">
          <h3 className="hover:text-yellow-500" onClick={() => setMenuOpen(false)}>Features</h3>
          <h3 className="hover:text-yellow-500" onClick={() => setMenuOpen(false)}>Technology</h3>
          <h3 className="hover:text-yellow-500" onClick={() => setMenuOpen(false)}>Agents</h3>
          <h3 className="hover:text-yellow-500" onClick={() => setMenuOpen(false)}>Pricing</h3>
          <h3 className="hover:text-yellow-500" onClick={() => setMenuOpen(false)}>Contact</h3>
